...
- [x] **P5.T10** — Printed invoice: the screen's own markup laid out as paperwork behind `@media print`, with **how many items go on a page** configurable per browser. No print route and no PDF service — one document, one set of figures.
