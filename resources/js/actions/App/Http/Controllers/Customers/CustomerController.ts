...
/**
* @see \App\Http\Controllers\Customers\CustomerController::index
* @see app/Http/Controllers/Customers/CustomerController.php:32
* @route '/customers'
*/
...
/**
* @see \App\Http\Controllers\Customers\CustomerController::create
* @see app/Http/Controllers/Customers/CustomerController.php:72
...
/**
* @see \App\Http\Controllers\Customers\CustomerController::store
* @see app/Http/Controllers/Customers/CustomerController.php:77
* @route '/customers'
*/
...
/**
* @see \App\Http\Controllers\Customers\CustomerController::show
* @see app/Http/Controllers/Customers/CustomerController.php:90
...
/**
* @see \App\Http\Controllers\Customers\CustomerController::edit
* @see app/Http/Controllers/Customers/CustomerController.php:103
...
/**
* @see \App\Http\Controllers\Customers\CustomerController::update
* @see app/Http/Controllers/Customers/CustomerController.php:112
* @route '/customers/{customer}'
*/
...
/**
* @see \App\Http\Controllers\Customers\CustomerController::destroy
* @see app/Http/Controllers/Customers/CustomerController.php:121
* @route '/customers/{customer}'
*/
