...
* @see app/Http/Controllers/Catalog/ProductController.php:28
* @route '/products'
*/
...
/**
* @see \App\Http\Controllers\Catalog\ProductController::store
* @see app/Http/Controllers/Catalog/ProductController.php:82
* @route '/products'
*/
...
* @see app/Http/Controllers/Catalog/ProductController.php:91
...
/**
* @see \App\Http\Controllers\Catalog\ProductController::destroy
* @see app/Http/Controllers/Catalog/ProductController.php:100
* @route '/products/{product}'
*/
...
*/
export const purchase = (args: { product: number | { id: number } } | [product: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/products/{product}/purchase'
*/
purchase.url = (args: { product: number | { id: number } } | [product: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { product: args }
    }
...
* @route '/products/{product}/purchase'
*/
purchase.post = (args: { product: number | { id: number } } | [product: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: purchase.url(args, options),
    method: 'post',
})
...
* @route '/products/{product}/purchase'
*/
const purchaseForm = (args: { product: number | { id: number } } | [product: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/products/{product}/purchase'
*/
purchaseForm.post = (args: { product: number | { id: number } } | [product: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: purchase.url(args, options),
    method: 'post',
})
...
*/
export const sell = (args: { product: number | { id: number } } | [product: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/products/{product}/sell'
*/
sell.url = (args: { product: number | { id: number } } | [product: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { product: args }
    }
...
* @route '/products/{product}/sell'
*/
sell.post = (args: { product: number | { id: number } } | [product: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: sell.url(args, options),
    method: 'post',
})
...
* @route '/products/{product}/sell'
*/
const sellForm = (args: { product: number | { id: number } } | [product: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/products/{product}/sell'
*/
sellForm.post = (args: { product: number | { id: number } } | [product: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: sell.url(args, options),
    method: 'post',
})
